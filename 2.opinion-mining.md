...
- un répertoire *positive* qui contient une dizaine de messages classés comme globalement positifs ;
- un répertoire *negative* qui contient une dizaine de messages classés comme globalement négatifs ;
- un autre répertoire *data* avec :
...
- et enfin un répertoire *predict* qui contient la modélisation des deux nouveaux messages à classer.
...
À présent, vous devriez être en mesure d’enregistrer dans une variable `V` la taille du vocabulaire.
